...
export class NanomaterialentityComponent implements OnInit {
    ...
    //                     Consts.QUERY_NANOMATERIAL_EDIT,
    //                     'sampleId=' +
    //                         this.nanomaterialSampleId +
    //                         '&dataId=' +
    //                         this.nanomaterialDataId
    //                 )
    //                 .subscribe(
    //                     (data) => {
    //                         this.editData = data;
    ...
    //                         this.nanomaterialService.setComposingElementsArray(
    //                             this.composingElementsArray
    //                         ); // @TODO move this to setNanomaterialEditData
    //                     },
    ...
    //         if (
    //             this.selectedBiopolymerType === '[other]' ||
    //             this.selectedBiopolymerType === 'other'
    //         ) {
    ...
    //         this.nanomaterialService.setNewNanomaterialType(
    //             this.newNanomaterialType,
    //             this.nanomaterialSampleId,
    //             this.description
    //         );
    ...
    //         if (
    //             this.newNanomaterialType !== 'other' &&
    //             this.newNanomaterialType !== '[other]'
    //         ) {
    ...
    //         temp['composingElements'] =
    //             this.nanomaterialService.getComposingElementsArray();
    ...
    //         this.apiService
    //             .doPost(Consts.QUERY_NANOMATERIAL_DELETE, this.editData)
    //             .subscribe(
    //                 (data) => {
    //                     console.log(
    //                         'Return data from QUERY_NANOMATERIAL_DELETE: ',
    //                         data
    //                     );
    //                 },
    //                 (err) => {
    ...
    //         this.setupData['nanomaterialEntityTypes'].push(
    //             this.newNanomaterialTypeText
    //         );
    ...
    //         if (
    //             this.newNanomaterialTypeTrailer !== 'other' &&
    //             this.newNanomaterialTypeTrailer !== '[other]'
    //         ) {
