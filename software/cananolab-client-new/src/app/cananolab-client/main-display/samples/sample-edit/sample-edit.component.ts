  ...
  ngOnInit(): void {
      this.route.params.subscribe(
          (params: Params) => {
              ...
              console.log('MHL Params: ', params);
              console.log('MHL params[\'sampleId\']: ', params['sampleId']);

             this.sampleData = this.getSampleEditData( ).subscribe(
                 data => {
                     this.sampleData = data;
                     console.log('MHL ************************************: ' ,  this.sampleData );
                     console.log('MHL ************************************sampleName: ' ,  this.sampleData.sampleName );
                     this.pointOfContacts = this.sampleData.pointOfContacts;
                     console.log('MHL ************************************pointOfContacts: ' ,  this.sampleData.pointOfContacts );
